	...
	public static class GattServiceProvider
	{
		public static List<GattServiceItemModel> GetServices()
		{
			...
			gattServices.Add(new GattServiceItemModel()
			{
				...
				Characteristics = new List<GattServiceCharacteristicItemModel>()
					{
						new GattServiceCharacteristicItemModel() { Name = "Ask my location", CharacteristicUuid = new Guid(AppConstants.GattCharLocationTrackingAskMyLocation), Properties = CharacteristicProperties.Notify | CharacteristicProperties.Read, Permissions = GattPermissions.Read },
